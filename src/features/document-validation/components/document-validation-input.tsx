                                ...
                                >
                                    ...
                                    <TabsContent value='file' className='pt-2'>
                                        ...
                                        {!frontsideImageBase64 && !frontsideLoading && (
                                            <div className='flex flex-col items-center justify-center rounded-md border-2 border-dashed border-muted-foreground/25 p-6 transition-colors hover:border-muted-foreground/50'>
                                                <div className='flex flex-col items-center justify-center'>
                                                    <ImageUp className='mb-2 h-12 w-12 text-muted-foreground' />
